...
const Chat = () => {
  ...
  return (
    <div className="nav-item absolute top-16 right-5 w-96 rounded-lg bg-white p-8 md:right-52 dark:bg-[#42464D]">
      ...
      <div className="mt-5">
        {chatData?.map((item: ChatItem, index) => (
          <div
            key={index}
            className="border-color flex cursor-pointer items-center gap-5 border-b-1 p-3 leading-8"
          >
